...
public class ListarPorProductoCommand implements Command {

	@Override
	public Context execute(Object transfer) {
		Set<TProductoEnPlataforma> res = FactoriaServicioAplicacion.getInstancia().generaSAProductoEnPlataforma()
				.listarPorProducto((int) transfer);
		if (res == null) {
			return new Context(Evento.RES_LISTAR_PP_X_PRODUCTO_KO, res);
		} else {
			return new Context(Evento.RES_LISTAR_PP_X_PRODUCTO_OK, res);
		}
	}
}
